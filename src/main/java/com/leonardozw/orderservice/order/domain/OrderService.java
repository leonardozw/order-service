...
import com.leonardozw.orderservice.order.event.OrderAcceptedMessage;
import com.leonardozw.orderservice.order.event.OrderDispatchedMessage;
...
public class OrderService {
    ...
    private void publishOrderAcceptedEvent(Order order){
        ...
        log.info("Result of sending data for order with id {}: {}", result);
    }
